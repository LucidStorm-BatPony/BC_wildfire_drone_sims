...
![Wind-day megafire exposure vs sniffer configuration](figures/sniffer_exposure.png)
...
![Season-scale economics](figures/season_economics.png)
*Left: suppression cost convexity — the network's case is intercepting fires in the green window. Right: season net value by configuration from `unified_season_sim.py`; hatched region is network cost. Figures generated by scripts in `figures/` (requires matplotlib).*
