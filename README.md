...
*Left: suppression cost convexity — the network's case is intercepting fires in the green window. Right: season net value by configuration from `unified_season_sim.py`; hatched region is network cost. Figures generated by make_figure.py and make_sniffer_figure.py (requires matplotlib).*
